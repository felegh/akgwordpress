...
// Heading Font
$heading_font_type = get_theme_mod( 'namaha-heading-font-type', customizer_library_get_default( 'namaha-heading-font-type') );
...
if ( $heading_font_type == 'theme-font' ) {
	...
	$fontstack = get_theme_mod( 'namaha-heading-custom-font', customizer_library_get_default( 'namaha-heading-custom-font') );
}
...
if ( $fontmod != customizer_library_get_default( $font ) || $heading_font_type == 'custom-font' ) {
    ...
    $fontletterspacing = 'namaha-heading-font-letter-spacing';
    ...
    // Body Font
    $body_font_type = get_theme_mod( 'namaha-body-font-type', customizer_library_get_default( 'namaha-body-font-type') );
    ...
    if ( $body_font_type == 'theme-font' ) {
    	...
    	$fontstack = get_theme_mod( 'namaha-body-custom-font', customizer_library_get_default( 'namaha-body-custom-font') );
    }

    if ( $fontmod != customizer_library_get_default( $font ) || $body_font_type == 'custom-font' ) {
    ...
    // Body Font Weight
    $fontweight = 'namaha-body-font-weight';
    $fontweightmod = get_theme_mod( $fontweight, customizer_library_get_default( $fontweight ) );
    ...
    $fontletterspacing = 'namaha-body-font-letter-spacing';
    $fontletterspacingmod = get_theme_mod( $fontletterspacing, customizer_library_get_default( $fontletterspacing ) );
