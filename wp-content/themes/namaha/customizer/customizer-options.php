...
// 	    $options['namaha-header-center-aligned-breakpoint'] = array(
// 	    	'id' => 'namaha-header-center-aligned-breakpoint',
// 	    	'label'   => __( 'Center Aligned Header Activation Width', 'namaha' ),
// 	    	'section' => $section,
// 	    	'type'    => 'pixels',
// 	    	'default' => 780,
// 	    	'description' => __( 'The screen width in pixels at which the header contents should be centered', 'namaha' )
// 	    );
    ...
    $options['namaha-social-right-aligned-buttons-anchored'] = array(
    	'id' => 'namaha-social-right-aligned-buttons-anchored',
