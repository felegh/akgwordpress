...
function namaha_customizer_library_build_styles() {
    ...
    /*
    // Slider text overlay and button rollover opacity
	$opacity = 'namaha-slider-text-overlay-opacity';
	$opacitymod = get_theme_mod( $opacity, customizer_library_get_default( $opacity ) );
    ...
    if ( $opacitymod !== customizer_library_get_default( $opacity ) ) {
    	...
    	Customizer_Library_Styles()->add( array(
    		...
    		'declarations' => array(
    			'background-color' => 'rgba(255, 255, 255, '. floatval( $opacitymod ) .')'
    		)
    	) );
    ...
    */
    ...
    $opacity = 'namaha-header-image-text-overlay-opacity';
    $opacitymod = get_theme_mod( $opacity, customizer_library_get_default( $opacity ) );
